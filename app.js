...
function postTemplate(p, liked, commentCount) {
  ...
  const titleBadge = u.title
    ...
    : "";
  const pinBadge = p.pinned ? `<span class="title-badge" style="color:#ffd400;border-color:#ffd400;">📌 Pinned</span>` : "";
...
async function toggleLike(postId) {
  if (IS_BLOCKED) { alert("Aap block hain, like nahi kar sakte."); return; }
