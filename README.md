...
## ⚠️ Already have this deployed? Run this patch once

If you already set up the database before, open Supabase SQL Editor and run `fix-and-upgrade.sql` **once**. It fixes a bug where likes silently failed to save (a missing permission blocked the like-count update), and turns on realtime so new posts/likes/comments appear instantly for everyone without needing a manual refresh.
